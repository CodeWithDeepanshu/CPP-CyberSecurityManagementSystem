...
public:
    ...
    void operator++() { if(accessLevel == 1) accessLevel = 2; }
...
int main() {
    ...
    do {
        ...
        cout << "7. Admin: Reset Password\n";
        cout << "8. Admin: Delete User\n";
        cout << "9. Admin: View All Users\n";
        cout << "10. Show Logs\n";
        cout << "0. Exit\n";
        cout << "Enter choice: ";
        cin >> choice;
        if(choice == 1) {
            if(userCount < MAX) {
                string u,p; int level;
                cout << "Enter username: "; cin >> u;
                cout << "Enter password: "; cin >> p;
                cout << "Role? (1=User,2=Admin): "; cin >> level;
                users[userCount] = User(u,p,level);
                userCount++;
            } else cout << "User database full!\n";
        }
        else if(choice == 2) {
            string u,p;
            cout << "Enter username: "; cin >> u;
            cout << "Enter password (or '-' for guest): "; cin >> p;
            bool success = false;
            ...
            if(userCount>=2) {
                cout << (comparePassword(users[0],users[1]) ? 
                        "Passwords match.\n":"Passwords differ.\n");
            } else cout << "Need at least 2 users.\n";
        }
        else if(choice == 4) {
            if(userCount>0) {
                ++users[0];
            ...
            if(userCount>=2) {
                ...
                cout << "Merged User: "; merged.showDetails();
            }
        }
        else if(choice == 6) {
            ...
            cout << "Enter target username: "; cin >> uname;
            ...
            string uname; cout << "Enter username to delete: "; cin >> uname;
